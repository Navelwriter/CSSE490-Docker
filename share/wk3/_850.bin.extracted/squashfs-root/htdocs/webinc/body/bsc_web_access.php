...
<div class="blackbox">
	<h2><?echo i18n("WINDOWS FILE SHARING (SAMBA)");?></h2>
	<div class="textinput">
		<span class="name"><?echo i18n("Windows File Sharing (SAMBA)");?></span>
		<span class="value"><input type="radio" name="smb_auth" value="1"><?echo i18n("Require access point's admin password");?></span>
	</div>
	<div class="textinput">
		<span class="name"></span>
			<span class="value"><input type="radio" name="smb_auth" value="0" checked><?echo i18n("Allow all users to access (no password)");?></span>
	</div>
	<div class="gap"></div>
</div>
