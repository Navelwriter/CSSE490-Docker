...
Page.prototype =
{
	services: "DEVICE.ACCOUNT,DEVICE.TIME,DEVICE.HOSTNAME,PHYINF.WAN-1,INET.WAN-1,INET.WAN-2,INET.WAN-3,INET.WAN-4,WAN,SAMBA,REBOOT" + "<? if($FEATURE_PARENTALCTRL=='1') echo ',OPENDNS4';?>",
	OnLoad: function()
	{
