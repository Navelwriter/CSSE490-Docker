							...
							<td width="36" class="tdbg"><img src="webfile_images/).png" alt="" width="15" height="15"></td>
											...
											<table width="960" border="0" cellpadding="0" cellspacing="0">
												<tr onMouseUp="location.href='photo.php'">
													...
													<td width="868" height="91" class="text_1"><? echo I18N("h", "Photos");?></td>
																<td width="36" class="tdbg"><img src="webfile_images/).png" alt="" width="15" height="15"></td>
															</tr>
														</table>
													</td>
											...
											<table width="960" border="0" cellpadding="0" cellspacing="0">
												<tr onMouseUp="location.href='movie.php'">
													...
													<td width="868" height="56" class="text_1"><? echo I18N("h", "Videos");?></td>
																<td width="36" class="tdbg"><img src="webfile_images/).png" alt="" width="15" height="15"></td>
															</tr>
														</table>					 
													</td>
											...
											<table width="960" border="0" cellpadding="0" cellspacing="0">
												<tr onMouseUp="location.href='doc.php'">
													...
													<td width="868" height="91" class="text_1"><? echo I18N("h", "Documents");?></td>
																<td width="36" class="tdbg"><img src="webfile_images/).png" alt="" width="15" height="15"></td>
															</tr>
														</table>
													</td>
